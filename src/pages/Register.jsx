          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              <div className="mb-8">
                ...
                <p className="text-gray-600">Start protecting what matters most</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label className="flex items-start">
                  <input type="checkbox" className="w-4 h-4 text-cyan-600 rounded mt-1" />
                  <span className="ml-2 text-sm text-gray-600">
                    I agree to the <a href="#" className="text-cyan-600 hover:text-cyan-700">Terms & Privacy Policy</a>
                  </span>
                </label>
